...
@router.post("/", response_model=ShowFlashcard, status_code=status.HTTP_201_CREATED, operation_id="create_flashcard")
...
@router.get("/", response_model=list[ShowFlashcard], operation_id="read_flashcards")
...
@router.get("/random", response_model=ShowFlashcard, operation_id="read_random_flashcard")
...
@router.get("/{flashcard_id}", response_model=ShowFlashcard, operation_id="read_flashcard")
